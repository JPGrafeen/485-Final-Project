...
void Cache::update_MRU(unsigned int Index, unsigned int Way)
{
    switch(Way)
    {
        ...
        case 2: m_pLRU[Index][0] = 0; m_pLRU[Index][1] = 1; m_pLRU[Index][4] = 0; break; //left -> right -> left     -> way 2
        case 3: m_pLRU[Index][0] = 0; m_pLRU[Index][1] = 1; m_pLRU[Index][4] = 1; break; //left -> right -> right    -> way 3
        case 4: m_pLRU[Index][0] = 1; m_pLRU[Index][2] = 0; m_pLRU[Index][5] = 0; break; //right -> left -> left     -> way 4
        case 5: m_pLRU[Index][0] = 1; m_pLRU[Index][2] = 0; m_pLRU[Index][5] = 1; break; //right -> left -> right    -> way 5
        case 6: m_pLRU[Index][0] = 1; m_pLRU[Index][2] = 1; m_pLRU[Index][6] = 0; break; //right -> right -> left    -> way 6
        case 7: m_pLRU[Index][0] = 1; m_pLRU[Index][2] = 1; m_pLRU[Index][6] = 1; break; //right -> right -> right   -> way 7
    }
}
